...
import net.aoliao.web.italker.push.bean.api.message.MessageCreateModel;
import net.aoliao.web.italker.push.bean.card.MessageCard;
import net.aoliao.web.italker.push.bean.db.Group;
import net.aoliao.web.italker.push.bean.db.Message;
import net.aoliao.web.italker.push.bean.db.User;
import net.aoliao.web.italker.push.factory.GroupFactory;
import net.aoliao.web.italker.push.factory.MessageFactory;
