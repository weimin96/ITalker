package net.aoliao.web.italker.push.utils;
...
public class PushDispatcher {
    private static final String appId = "KPYcXfnHs19kITbkvewVb8";
    private static final String appKey = "TnrJPLOTeXAdHXCRedUZM6";
    private static final String masterSecret = "mFeOVhYRVz8lSqP4xaJdw3";
